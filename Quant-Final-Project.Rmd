...
![Table 3 (New York City Census Tracts)](table3.png)
...
The regression model is the method which will best help me to answer my research question. By creating such interaction terms, conducting a log transformation of income, and attempting a continuous to categorical variable conversion, one of these methods will present an interaction model with a best fit. The best fit of this model tells me that the model is closest to predicting the results of my dependent variable depending on the variability of my independent variables. Because my research question is to understand how my independent variables impact the dependent variable of travel time to work, a regression model will best help me to come to a conclusion based on its results.
