...
```{r}
coeff_names <- c("Means of Transportation\nto work(compared to car" = "JWTR_label",
                 "Income (dollars)" = "PINCP",
                 "Income\n(log-transformed)" = "log(PINCP)",
                 "Age (years)" = "AGEP",
                 "Physical Disability\n(compared to not disabled)" = "DPHY_label",
                 "Interaction: Disability and Age" = "DPHY_label:AGEP",
                 "Interaction: Means of Transportation\nto Work and Age" = "JWTR_label:AGEP")
...
>>>>>>> db954458ea8755ddd982fc853c9dca9d902a53e4
